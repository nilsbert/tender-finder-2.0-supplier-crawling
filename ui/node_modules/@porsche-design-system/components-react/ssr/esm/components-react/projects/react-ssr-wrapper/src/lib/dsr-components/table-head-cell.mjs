...
import { getTableHeadCellCss as getComponentCss$f } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRTableHeadCell extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$f(active, direction, this.props.hideLabel, this.props.multiline));
