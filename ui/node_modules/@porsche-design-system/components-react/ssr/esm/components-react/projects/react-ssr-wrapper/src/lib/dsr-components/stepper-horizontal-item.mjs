...
import { getStepperHorizontalItemCss as getComponentCss$l } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRStepperHorizontalItem extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$l(this.props.state, this.props.disabled));
        return (jsxs(Fragment, { children: [jsxs("template", { shadowroot: "open", shadowrootmode: "open", shadowrootdelegatesfocus: "true", children: [jsx("style", { dangerouslySetInnerHTML: { __html: style } }), jsx(Fragment, { children: jsxs("button", { type: "button", "aria-disabled": !this.props.state || this.props.disabled ? 'true' : null, "aria-current": this.props.state === 'current' ? 'step' : null, children: [isStateCompleteOrWarning(this.props.state) ? (jsx(PIcon, { className: "icon", name: getStepperHorizontalIconName(this.props.state), size: "inherit", color: getStepperHorizontalIconName(this.props.state), "aria-hidden": "true" })) : (jsx("span", { className: "icon", "aria-hidden": "true" })), this.props.state && jsxs("span", { className: "sr-only", children: [this.props.state, ": "] }), jsx("slot", {})] }) })] }), this.props.children] }));
    }
}
