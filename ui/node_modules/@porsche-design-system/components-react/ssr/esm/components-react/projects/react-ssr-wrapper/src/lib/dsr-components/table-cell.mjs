...
import { getTableCellCss as getComponentCss$g } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRTableCell extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$g(this.props.multiline));
