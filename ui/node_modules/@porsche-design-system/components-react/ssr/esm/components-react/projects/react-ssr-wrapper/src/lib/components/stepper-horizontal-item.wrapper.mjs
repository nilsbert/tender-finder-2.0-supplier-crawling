...
const PStepperHorizontalItem = /*#__PURE__*/ forwardRef(({ disabled = false, state, className, children, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                ...{ "role": "listitem" },
                children: (jsx(DSRStepperHorizontalItem, { disabled, state, children })),
            }
            : {
                children,
