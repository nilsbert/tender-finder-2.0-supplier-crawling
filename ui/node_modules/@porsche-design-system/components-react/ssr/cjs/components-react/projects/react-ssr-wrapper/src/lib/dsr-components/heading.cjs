...
class DSRHeading extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getHeadingCss(this.props.size, this.props.weight, this.props.align, this.props.color, this.props.hyphens, this.props.ellipsis));
