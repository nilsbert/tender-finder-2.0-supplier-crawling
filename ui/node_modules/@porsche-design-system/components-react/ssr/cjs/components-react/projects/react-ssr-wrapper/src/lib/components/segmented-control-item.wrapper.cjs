...
// @ts-ignore
{ aria, disabled = false, icon, iconSource, label, value, className, children, compact, selected, state, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                children: (jsxRuntime.jsx(segmentedControlItem.DSRSegmentedControlItem, { aria, disabled, icon, iconSource, label, value, compact, selected, state, children })),
            }
            : {
                children,
