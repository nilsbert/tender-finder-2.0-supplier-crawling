...
const PStepperHorizontalItem = /*#__PURE__*/ react.forwardRef(({ disabled = false, state, className, children, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                ...{ "role": "listitem" },
                children: (jsxRuntime.jsx(stepperHorizontalItem.DSRStepperHorizontalItem, { disabled, state, children })),
            }
            : {
                children,
