...
const PLinkTile = /*#__PURE__*/ react.forwardRef(({ align = 'bottom', aria, aspectRatio = '4/3', compact = false, description, download, gradient = false, href, label, rel, size = 'medium', target = '_self', weight = 'semi-bold', className, children, ...rest }, ref) => {
