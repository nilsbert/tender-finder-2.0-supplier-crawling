...
import { colorSuccessFrostedSoft, colorSuccessLow, colorSuccess, colorFrostedSoft, colorContrastLower, colorPrimary, borderWidthThin, spacingStaticXs } from '../styles.mjs';
